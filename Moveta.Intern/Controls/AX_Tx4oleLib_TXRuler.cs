...
namespace Moveta.Intern
{
	...
	/// <summary>
	/// </summary>
	[ComSourceInterfaces(typeof(AX_Tx4oleLib_TXRuler__DTX4OLEEvents))]
	public class AX_Tx4oleLib_TXRuler : SalActiveX, AX_Tx4oleLib_TXRuler__DTX4OLEEvents
	{
		
		/// <summary>
		/// This is the real COM object class.
		/// </summary>
		internal Tx4oleLib_TXRuler _CoClass = new Tx4oleLib_TXRuler();
		...
		/// Default Constructor.
		/// </summary>
		public AX_Tx4oleLib_TXRuler(): base("{26BD990D-E7D0-11DD-AA41-0013D350667C}")
		{
		...
		{
			// 
			// AX_Tx4oleLib_TXRuler
			// 
			this.Name = "AX_Tx4oleLib_TXRuler";
		...
		public SalBoolean PropSetEnablePageMargins(SalBoolean EnablePageMargins)
		{
			...
			{
				return _CoClass.PropSetEnablePageMargins(EnablePageMargins);
			}
		}
		...
		public SalBoolean PropGetEnablePageMargins(ref SalBoolean returnValue)
		{
			using (new SalContext(this))
			{
				return _CoClass.PropGetEnablePageMargins(ref returnValue);
			}
		}
		...
		public SalBoolean PropSetDirection(SalNumber Direction)
		{
			using (new SalContext(this))
			{
				return _CoClass.PropSetDirection(Direction);
			}
		}
		...
		public SalBoolean PropGetDirection(ref SalNumber returnValue)
		{
			using (new SalContext(this))
			{
				return _CoClass.PropGetDirection(ref returnValue);
			}
		}
		...
		public SalBoolean PropSetScaleUnits(SalNumber ScaleUnits)
		{
			using (new SalContext(this))
			{
				return _CoClass.PropSetScaleUnits(ScaleUnits);
			}
		}
		...
		public SalBoolean PropGetScaleUnits(ref SalNumber returnValue)
		{
			using (new SalContext(this))
			{
				return _CoClass.PropGetScaleUnits(ref returnValue);
			}
		}
		...
		#region AX_Tx4oleLib_TXRuler__DTX4OLEEvents Implementation
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.Change()
		{
			if (Change != null)
			{
				Change();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.DblClick()
		{
			if (DblClick != null)
			{
				DblClick();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.HScroll()
		{
			if (HScroll != null)
			{
				HScroll();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.VScroll()
		{
			if (VScroll != null)
			{
				VScroll();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.PosChange()
		{
			if (PosChange != null)
			{
				PosChange();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.Move()
		{
			if (Move != null)
			{
				Move();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.Size()
		{
			if (SizeEvent != null)
			{
				SizeEvent();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.KeyDown(ref short KeyCode, ref short Shift)
		{
			if (KeyDown != null)
			{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.KeyPress(ref short KeyAscii)
		{
			if (KeyPress != null)
			{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.KeyUp(ref short KeyCode, ref short Shift)
		{
			if (KeyUp != null)
			{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.MouseDown(ref short Button, ref short Shift, ref int X, ref int Y)
		{
			if (MouseDown != null)
			{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.MouseMove(ref short Button, ref short Shift, ref int X, ref int Y)
		{
			if (MouseMove != null)
			{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.MouseUp(ref short Button, ref short Shift, ref int X, ref int Y)
		{
			if (MouseUp != null)
			{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.FieldChanged(ref short FieldId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.FieldClicked(ref short FieldId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.FieldCreated(ref short FieldId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.FieldDblClicked(ref short FieldId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.FieldDeleted(ref short FieldId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.FieldSetCursor(ref short FieldId, ref short MousePointer)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectClicked(ref short ObjectId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectMoved(ref short ObjectId)
		{
			if (ObjectMoved != null)
			{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectSized(ref short ObjectId)
		{
			if (ObjectSized != null)
			{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.Click()
		{
			if (Click != null)
			{
				Click();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectDblClicked(ref short ObjectId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.Error(ref short Number, ref string Description, ref int Scode, ref string Source, ref string HelpFile, ref int HelpContext, ref bool CancelDisplay)
		{
			if (Error != null)
			{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectDeleted(ref short ObjectId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectCreated(ref short ObjectId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ConnectTools()
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectSetZoom(ref short ObjectId, ref short ZoomFactor, ref bool Processed)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectGetZoom(ref short ObjectId, ref short ZoomFactor)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectPrint(ref short ObjectId, ref int Device, ref int Left, ref int Top, ref int Right, ref int Bottom, ref bool Processed)
		{
			if (ObjectPrint != null)
			{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectGetData(ref short ObjectId, object ObjectData)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectSetData(ref short ObjectId, object ObjectData)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectGethWnd(ref short ObjectId, ref short KindOfObject, ref int hWnd)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectScrollOut(ref short ObjectId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.AutoLink()
		{
			if (AutoLink != null)
			{
				AutoLink();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.FieldEntered(ref short FieldId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.FieldLeft(ref short FieldId)
		{
			if (FieldLeft != null)
			{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.HExpand()
		{
			if (HExpand != null)
			{
				HExpand();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.VExpand()
		{
			if (VExpand != null)
			{
				VExpand();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.Zoomed()
		{
			if (Zoomed != null)
			{
				Zoomed();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.CharFormatChange()
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.PageFormatChange()
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ParagraphChange()
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ParagraphFormatChange()
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.CaretOut()
		{
			if (CaretOut != null)
			{
				CaretOut();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.CaretOutLeft()
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.CaretOutTop()
		{
			if (CaretOutTop != null)
			{
				CaretOutTop();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.CaretOutRight()
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.CaretOutBottom()
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.AutoScroll()
		{
			if (AutoScroll != null)
			{
				AutoScroll();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.KeyStateChange()
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ViewClicked(ref short FieldType, ref string FieldContents)
		{
			if (ViewClicked != null)
			{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ViewWordDblClicked(ref string SelectedText)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.TableCreated(ref short TableId, ref short NewTableId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.TableDeleted(ref short TableId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.HeaderFooterActivated(ref short HeaderFooter)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.HeaderFooterDeactivated(ref short HeaderFooter)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.FieldLinkClicked(ref short FieldId, ref short FieldType, ref string TypeData)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.StyleListChanged()
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.StyleChanged()
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.TableFormatChanged()
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.XMLNotWellFormed(ref int FilePos, ref int LineNumber, ref int LinePos, ref int Scode, ref string Description, ref string URL, ref bool CancelDisplay)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.XMLInvalid(ref int FilePos, ref int Scode, ref string Description, ref bool CancelDisplay)
		{
			if (XMLInvalid != null)
			{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.ObjectRightClicked(ref short ObjectId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.TextFrameActivated(ref short TextFrameId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.TextFrameDeactivated(ref short TextFrameId)
		{
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.PageChanged()
		{
			if (PageChanged != null)
			{
				PageChanged();
		...
		void AX_Tx4oleLib_TXRuler__DTX4OLEEvents.SectionChanged()
		{
		...
		/// <returns></returns>
		[DebuggerStepThrough]
		public new static AX_Tx4oleLib_TXRuler FromHandle(SalWindowHandle handle)
		{
			return ((AX_Tx4oleLib_TXRuler)SalWindow.FromHandle(handle, typeof(AX_Tx4oleLib_TXRuler)));
		}
		#endregion
	...
	public interface AX_Tx4oleLib_TXRuler__DTX4OLEEvents
	{
