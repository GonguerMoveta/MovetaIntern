...
namespace Moveta.Intern
{
	...
	public partial class frmDublPruef
	{
		...
		public frmDublPruef.tblDublTableWindow tblDubl;
		...
		private void InitializeComponent()
		{
			...
			this.tblDubl = (frmDublPruef.tblDublTableWindow)CreateTableWindow(typeof(frmDublPruef.tblDublTableWindow));
			...
			this.tblDubl.colDatum.Width = 68;
			...
			// tblDubl.colBez
			// 
			this.tblDubl.colBez.Name = "colBez";
			this.tblDubl.colBez.Title = "Rechnungsbez.";
			this.tblDubl.colBez.Width = 253;
			this.tblDubl.colBez.Enabled = false;
			this.tblDubl.colBez.Position = 4;
			...
			this.WindowActions += new PPJ.Runtime.Windows.WindowActionsEventHandler(this.frmDublPruef_WindowActions);
		...
		protected override void Dispose(bool disposing)
		{
			...
			if (disposing && App.frmDublPruef == this) 
			{
				App.frmDublPruef = null;
			}
