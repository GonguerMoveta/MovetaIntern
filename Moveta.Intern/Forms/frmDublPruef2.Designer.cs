...
namespace Moveta.Intern
{
	...
	public partial class frmDublPruef2
	{
		...
		public frmDublPruef2.tblDublTableWindow tblDubl;
		...
		private void InitializeComponent()
		{
			...
			this.tblDubl = (frmDublPruef2.tblDublTableWindow)CreateTableWindow(typeof(frmDublPruef2.tblDublTableWindow));
			...
			this.ClientArea.Controls.Add(this.tblDubl);
			...
			this.dfArztNr.Size = new System.Drawing.Size(30, 16);
			...
			this.bkgd4.Location = new System.Drawing.Point(5, 19);
			this.bkgd4.Size = new System.Drawing.Size(56, 16);
			...
			this.dfArztNr2.Location = new System.Drawing.Point(101, 19);
			...
			this.pbOk.Location = new System.Drawing.Point(143, 15);
			this.pbOk.Size = new System.Drawing.Size(60, 29);
			...
			this.pbDrucken.Location = new System.Drawing.Point(299, 15);
			...
			// tblDubl
			// 
			this.tblDubl.Name = "tblDubl";
			this.tblDubl.BackColor = System.Drawing.Color.White;
			this.tblDubl.Font = new Font("Tahoma", 9f, System.Drawing.FontStyle.Regular);
			this.tblDubl.Location = new System.Drawing.Point(11, 111);
			this.tblDubl.Size = new System.Drawing.Size(486, 272);
			this.tblDubl.UseVisualStyles = true;
			// 
			// tblDubl.colArztNr
			// 
			this.tblDubl.colArztNr.Name = "colArztNr";
			this.tblDubl.colArztNr.Title = "ArztNr";
			this.tblDubl.colArztNr.Width = 51;
			this.tblDubl.colArztNr.DataType = PPJ.Runtime.Windows.DataType.Number;
			this.tblDubl.colArztNr.Enabled = false;
			this.tblDubl.colArztNr.Format = "#0";
			this.tblDubl.colArztNr.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.tblDubl.colArztNr.Position = 1;
			// 
			// tblDubl.colRechNr
			// 
			this.tblDubl.colRechNr.Name = "colRechNr";
			this.tblDubl.colRechNr.Title = "RechNr";
			this.tblDubl.colRechNr.Width = 69;
			this.tblDubl.colRechNr.DataType = PPJ.Runtime.Windows.DataType.Number;
			this.tblDubl.colRechNr.Enabled = false;
			this.tblDubl.colRechNr.Format = "#0";
			this.tblDubl.colRechNr.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.tblDubl.colRechNr.Position = 2;
			// 
			// tblDubl.colDatum
			// 
			this.tblDubl.colDatum.Name = "colDatum";
			this.tblDubl.colDatum.Title = "Behdlgs.-Datum";
			this.tblDubl.colDatum.Width = 111;
			this.tblDubl.colDatum.DataType = PPJ.Runtime.Windows.DataType.DateTime;
			this.tblDubl.colDatum.Enabled = false;
			this.tblDubl.colDatum.Format = "dd.MM.yy";
			this.tblDubl.colDatum.Position = 3;
			// 
			// tblDubl.colSumme
			// 
			this.tblDubl.colSumme.Name = "colSumme";
			this.tblDubl.colSumme.Title = "Summe €";
			this.tblDubl.colSumme.Width = 144;
			this.tblDubl.colSumme.DataType = PPJ.Runtime.Windows.DataType.Number;
			this.tblDubl.colSumme.Enabled = false;
			this.tblDubl.colSumme.Format = "#,##0.00";
			this.tblDubl.colSumme.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.tblDubl.colSumme.Position = 4;
			this.tblDubl.TabIndex = 5;
			// 
			// bkgd5
			// 
			...
			this.bkgd5.Text = "/";
			this.bkgd5.Location = new System.Drawing.Point(95, 18);
			this.bkgd5.Size = new System.Drawing.Size(6, 16);
			...
			this.bkgd6.Text = "F12";
			this.bkgd6.Location = new System.Drawing.Point(161, 49);
			this.bkgd6.Size = new System.Drawing.Size(30, 16);
			this.bkgd6.TabIndex = 7;
			// 
			// bkgd7
			// 
			this.bkgd7.Name = "bkgd7";
			this.bkgd7.Font = new Font("Tahoma", 9f, System.Drawing.FontStyle.Regular);
			this.bkgd7.Text = "Drucker :";
			this.bkgd7.Location = new System.Drawing.Point(11, 73);
			...
			this.Text = "Dublettenprüfung";
			this.Location = new System.Drawing.Point(19, 21);
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.WindowActions += new PPJ.Runtime.Windows.WindowActionsEventHandler(this.frmDublPruef2_WindowActions);
		...
		protected override void Dispose(bool disposing)
		{
			...
			if (disposing && App.frmDublPruef2 == this) 
			{
				App.frmDublPruef2 = null;
			}
		...
		public partial class tblDublTableWindow
		{
			#region Window Controls
