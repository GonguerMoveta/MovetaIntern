...
namespace Moveta.Intern
{
	...
	public partial class frmMahn
	{
		...
		public SalListBox lbMahnAktionen;
		...
		private void InitializeComponent()
		{
			...
			this.lbMahnAktionen = new PPJ.Runtime.Windows.SalListBox();
			...
			this.ClientArea.Controls.Add(this.lbMahnAktionen);
			// 
			// StatusBar
			// 
			...
			// lbMahnAktionen
			// 
			this.lbMahnAktionen.Name = "lbMahnAktionen";
			this.lbMahnAktionen.HorizontalScrollbar = false;
			this.lbMahnAktionen.BackColor = System.Drawing.Color.White;
			this.lbMahnAktionen.Font = new Font("Tahoma", 14f, System.Drawing.FontStyle.Regular);
			this.lbMahnAktionen.SelectionMode = System.Windows.Forms.SelectionMode.One;
			this.lbMahnAktionen.Sorted = false;
			this.lbMahnAktionen.Location = new System.Drawing.Point(23, 15);
			this.lbMahnAktionen.Size = new System.Drawing.Size(396, 464);
			this.lbMahnAktionen.WindowActions += new PPJ.Runtime.Windows.WindowActionsEventHandler(this.lbMahnAktionen_WindowActions);
			this.lbMahnAktionen.TabIndex = 0;
			// 
			// dfSperre
			// 
			...
			this.dfSperre.Location = new System.Drawing.Point(23, 487);
			...
			this.Text = "Mahnungen / Mahnbescheide";
			this.Location = new System.Drawing.Point(104, 298);
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.WindowActions += new PPJ.Runtime.Windows.WindowActionsEventHandler(this.frmMahn_WindowActions);
