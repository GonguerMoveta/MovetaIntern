...
namespace Moveta.Intern
{
	...
	public partial class frmAusbatch
	{
		...
		private void InitializeComponent()
		{
			...
			this.pbZahlOk.Font = new Font("Tahoma", 9f, System.Drawing.FontStyle.Bold);
			this.pbZahlOk.Text = "&OK";
			this.pbZahlOk.Location = new System.Drawing.Point(56, 27);
			this.pbZahlOk.Size = new System.Drawing.Size(99, 84);
			this.pbZahlOk.Image = global::Moveta.Intern.Properties.Resources.ok;
			this.pbZahlOk.TextImageRelation = System.Windows.Forms.TextImageRelation.ImageAboveText;
			this.pbZahlOk.WindowActions += new PPJ.Runtime.Windows.WindowActionsEventHandler(this.pbZahlOk_WindowActions);
			this.pbZahlOk.TabIndex = 0;
			// 
			// frmAusbatch
			// 
			...
			this.Text = "Ausbatchen";
			this.Location = new System.Drawing.Point(99, 98);
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.WindowActions += new PPJ.Runtime.Windows.WindowActionsEventHandler(this.frmAusbatch_WindowActions);
		...
		protected override void Dispose(bool disposing)
		{
			...
			if (disposing && App.frmAusbatch == this) 
			{
				App.frmAusbatch = null;
			}
