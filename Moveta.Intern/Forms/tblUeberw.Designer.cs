...
namespace Moveta.Intern
{
	...
	public partial class tblUeberw
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "tblUeberw";
			this.ClientSize = new System.Drawing.Size(991, 379);
			this.Font = new Font("Tahoma", 9f, System.Drawing.FontStyle.Regular);
			this.MaximizeBox = false;
			this.MinimizeBox = false;
			this.Text = "Überweisungen im lfd. Monat";
			this.Location = new System.Drawing.Point(123, 158);
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.UseVisualStyles = true;
			this.WindowActions += new PPJ.Runtime.Windows.WindowActionsEventHandler(this.tblUeberw_WindowActions);
		...
		protected override void Dispose(bool disposing)
		{
			...
			if (disposing && App.tblUeberw == this) 
			{
				App.tblUeberw = null;
			}
