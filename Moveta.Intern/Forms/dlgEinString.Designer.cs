...
namespace Moveta.Intern
{
	...
	public partial class dlgEinString
	{
		...
		private void InitializeComponent()
		{
			...
			this.dfEin.Font = new Font("Microsoft Sans Serif", 8.25f, System.Drawing.FontStyle.Regular);
			...
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.WindowActions += new PPJ.Runtime.Windows.WindowActionsEventHandler(this.dlgEinString_WindowActions);
		...
		protected override void Dispose(bool disposing)
		{
			...
			if (disposing && App.dlgEinString == this) 
			{
				App.dlgEinString = null;
			}
