...
namespace Moveta.Intern
{
	...
	/// <summary>
	/// </summary>
	public class ShellBrowser_IJamNetConnectionDialog : SalObject
	{
		...
		/// Default Constructor.
		/// </summary>
		public ShellBrowser_IJamNetConnectionDialog(){ }
		public ShellBrowser_IJamNetConnectionDialog(COMInterface obj) : this()
		{
			this._Interface = obj;
		}
		#endregion
		...
		public SalBoolean PropGetRemotePath(ref SalString returnValue)
		{
			...
			try
			{
				returnValue = _Interface.RemotePath;
				return true;
			}
		...
		/// </summary>
		[Guid("41F0EE3A-0EDD-4B00-B48E-C97A78705D7F")]
