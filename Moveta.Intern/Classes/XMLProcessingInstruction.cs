...
namespace Moveta.Intern
{
	...
	public class XMLProcessingInstruction : XMLNode
	{
		...
		/// <returns></returns>
		public SalBoolean castToProcessingInstruction(XMLNode node)
		{
			#region Actions
			return __XML_Node_changeType(node, Const.XML_PROCESSING_INSTRUCTION_NODE);
			#endregion
		}
		...
		/// </summary>
		/// <returns></returns>
		public SalString getTarget()
		{
			#region Actions
			return __XML_ProcessingInstruction_getTarget();
			#endregion
		}
