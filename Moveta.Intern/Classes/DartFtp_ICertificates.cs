...
namespace Moveta.Intern
{
	...
	/// <summary>
	/// </summary>
	public class DartFtp_ICertificates : SalObject
	{
		...
		/// Default Constructor.
		/// </summary>
		public DartFtp_ICertificates(){ }
		public DartFtp_ICertificates(COMInterface obj) : this()
		{
			this._Interface = obj;
		}
		#endregion
		...
		/// <param name="returnValue"></param>
		/// <returns></returns>
		public SalBoolean Item(SalNumber Index, DartFtp_ICertificate returnValue)
		{
			#region Actions
			try
			{
		...
		/// </summary>
		[Guid("93D50101-C927-11D3-912C-00105A17B608")]
		[InterfaceType(System.Runtime.InteropServices.ComInterfaceType.InterfaceIsIDispatch)]
		public interface COMInterface
		{
			int Count { get; }
			DartFtp_ICertificate.COMInterface Item(int Index);
		}
	}
}
